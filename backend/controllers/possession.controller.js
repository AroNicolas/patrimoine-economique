    ...
    if (result.status === "OK") {
        ...
        if (patrimoineData) {
            ...
            if (writeResult.status === "OK") {
                ...
                console.error("Erreur lors de l'écriture dans le fichier :", writeResult.error);
        ...
        console.error("Erreur lors de la lecture du fichier :", result.error);
        res.status(500).json(result.error);
    }
};
